...
def browser_config(request):
    ...
    if browser_type == "chrome":
        ...
        # firefox_options.add_argument("--headless")  # uncomment if needed
        driver = webdriver.Firefox(options=firefox_options)

    elif browser_type == "edge":
        edge_options = EdgeOptions()
        # edge_options.add_argument("--headless")     # uncomment if needed
    ...
    driver.get("https://ims2-dev.celloscope.net/")
