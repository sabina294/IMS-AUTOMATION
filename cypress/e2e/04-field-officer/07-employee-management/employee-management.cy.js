...
describe("07. Employee Management Module Test Cases", function () {
  ...
  it("07.08. Verify the employee management draft button functions correctly.", function () {
    grid_employee_management.editDraftButton();
  });

  it("07.09. Verify that clicking the go back button on the employee management edit page redirects the user to the employee management list page.", function () {
    grid_employee_management.editGoBackButton();
  });

  it("07.10. Verify the user can filter inactive employee records using the status dropdown on the Employee Management List page.", function () {
    grid_employee_management.statusInactiveDropdownCheck();
  });

  it("07.11. Verify check if the filter for active results works correctly with the status dropdown.", function () {
    grid_employee_management.statusActiveDropdownCheck();
  });

  it("07.12. Verify that the search results are displayed correctly when searching by employee management name.", function () {
    grid_employee_management.searchInEmployeeName();
  });

  it("07.13. Verify the grid list resets successfully when the reset button is clicked on the employee management page.", function () {
    grid_employee_management.gridResetButtonCheck();
  });

  it("07.14. Verify that the grid list is refreshed successfully when the refresh button is clicked on the employee management page.", function () {
    grid_employee_management.gridRefreshButtonCheck();
  });

  it("07.15. Verify that the checkbox functions correctly.", function () {
    grid_employee_management.gridCheckboxCheck();
  });

  it("07.16. Verify that the checkbox lock button operates correctly when selected.", function () {
    grid_employee_management.gridCheckboxLockButtonCheck();
  });

  it("07.17. Verify that the checkbox unlock button operates correctly when selected.", function () {
    grid_employee_management.gridCheckboxUnlockButtonCheck();
  });

  it("07.18. Verify display the grid list successfully when the Draft button on is clicked on the employee management page", function () {
    grid_employee_management.gridDraftButton();
  });

  it("07.19. Verify display the grid list successfully when the Draft button off is clicked on the employee management page", function () {
    grid_employee_management.gridDraftButtonOff();
  });

  it("07.20. Verify check that the grid list content changes correctly from english to bangla.", function () {
