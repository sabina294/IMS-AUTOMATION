...
describe("14. Employee Management Module Test Cases", function () {
  ...
  it("14.06. Verify that the Search button displays the correct Employee Management records in My Tasks.", function () {
    create_employee_management.myTaskSearchButtonCheck();
  });

  it("14.07. Verify that an MFI Admin can approve an Employee Management record successfully.", function () {
    create_employee_management.approveEmployee();
  });

  it("14.08. Verify that the Action menu functions correctly for an Employee Management record.", function () {
    create_employee_management.actionButtonCheck();
  });

  it("14.09. Verify that the user can view the Employee Management details successfully.", function () {
    create_employee_management.viewEmployeeManagement();
  });

  it("14.10. Verify that clicking the Go Back button on the Employee Management View page redirects the user to the Employee Management List page.", function () {
    create_employee_management.viewGoBackButton();
  });

  it("14.11. Verify display employee profile details correctly", function () {
    create_employee_management.profileViewEmployeeManagement();
  });

  it("14.12. Verify navigate back to list page from profile view page", function () {
  ...
  it("14.30. Verify that validation messages are displayed for all required fields when submitting an empty Employee Management form.", function () {
    create_employee_management.createValidationMessageCheck();
  });

  it("14.31. Verify that validation messages are displayed for all required fields when approving an empty Employee Management form.", function () {
    create_employee_management.createApproveButtonCheck();
  });

  it("14.32. Verify that clicking the Go Back button on the Employee Management Create page redirects the user to the Employee Management List page.", function () {
    create_employee_management.createGoBackButtonCheck();
  });

  it("14.33. Verify that the Draft button saves the Employee Management record as a draft successfully.", function () {
    create_employee_management.createDraftButtonCheck();
  });

  it("14.34. Verify that the Search button displays the correct Employee Management records on the List page.", function () {
