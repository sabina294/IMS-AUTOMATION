// npm run auto
// npm run dev
// npx cypress run --spec cypress/e2e/01-mfi-admin/01-mis/52-regular-collection/regular-collection.cy.js --browser chrome --headed

import "cypress-file-upload";
import { grid_regural_collection } from "./regular-collection.po";

describe("52. Regular Collection Module Test Cases", function () {
    ...
    it("52.01. Verify Regular Collection Grid List Page loads successfully", function () {
        grid_regural_collection.gridRegularCollectionListPage();
    });

    // it("52.02. Verify Successful Search Result by Regular Collection Name", function () {
    //     grid_regural_collection.searchInRegularCollectionName();
    // });

    it('52.03. Verify the functionality and expected behavior of the "Successful Office Status" dropdown.', function () {
