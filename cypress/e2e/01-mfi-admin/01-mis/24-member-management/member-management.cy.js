...
describe("24. Member Management Module Test Cases", function () {
  ...
  it("24.03. Verify that the created Member Management record appears in My Tasks.", function () {
    create_member_management.myTaskMenuMember();
  });

  it("24.04. Verify that the Office dropdown filter works correctly on the My Tasks page.", function () {
    create_member_management.myTaskMemberOfficeDropdownCheck();
  });

  it("24.05. Verify that the Reset button clears all applied filters on the My Tasks page.", function () {
    create_member_management.myTaskResetButtonCheck();
  });

  it("24.06. Verify that the Refresh button reloads the My Tasks list successfully.", function () {
    create_member_management.myTaskRefreshButtonCheck();
  });

  it("24.07. Verify that the Search button displays the correct Member Management records in My Tasks.", function () {
    create_member_management.myTaskSearchButtonCheck();
  });

  it("24.08. Verify that the MFI Admin can successfully approve a Member Management record after creation.", function () {
    create_member_management.approveMemberManagement();
  });

  it("24.09. Verify that the action button performs the expected action successfully.", function () {
    create_member_management.actionButtonCheck();
  });

  it("24.10. Verify that the user can successfully view Member Management information, including name and description.", function () {
    create_member_management.viewMemberManagement();
  });

  it("24.11. Verify that clicking the Go Back button on the Member Management view page redirects the user to the Member Management list page.", function () {
    create_member_management.viewGoBackButton();
  });

  it("24.12. Verify that the reset button functions correctly on the Member Management edit page.", function () {
    create_member_management.editResetButton();
  });

  it("24.13. Verify that the Draft button functions correctly on the Member Management edit page.", function () {
    create_member_management.editDraftButton();
  });

  it("24.14. Verify that the Submit button functions correctly on the Member Management edit page.", function () {
    create_member_management.editSubmitButton();
  });

  it("24.15. Verify that the Approve button functions correctly on the Member Management edit page.", function () {
    create_member_management.editApproveButton();
  });

  it("24.16. Verify that clicking the Go Back button on the Member Management edit page redirects the user to the Member Management list page.", function () {
  ...
  it("24.27. Verify that the grid list is displayed successfully when the Draft button is disabled on the Member Management page.", function () {
    create_member_management.gridDraftButtonOff();
  });

  it("24.28. Verify that the office selection works correctly from the office dropdown on the Member Management list page.", function () {
    create_member_management.selectofficeDropdown();
  });

  it("24.29. Verify that validation messages appear for required fields when the Approve button is clicked with empty inputs.", function () {
    create_member_management.createApproveButtonCheck();
  });

  it("24.30. Verify that validation messages appear for required fields when the Submit button is clicked with empty inputs.", function () {
    create_member_management.createSubmitButtonCheck();
  });

  it("24.31. Verify that validation messages appear for required fields when the Draft button is clicked with empty inputs.", function () {
    create_member_management.createDraftButtonCheck();
  });

  it("24.32. Verify that the Reset button functions correctly when clicked with empty inputs.", function () {
    create_member_management.createResetButtonCheck();
  });

  it("24.33. Verify that clicking the Go Back button redirects the user successfully from the create page.", function () {
    create_member_management.createGoBackButtonCheck();
  });

  it("24.34. Verify that clicking the Search button on the Member Management grid page displays the correct search results.", function () {
    create_member_management.gridSearchButtonCheck();
  });

  it("24.35. Verify that the grid list content changes successfully from English to Bangla.", function () {
