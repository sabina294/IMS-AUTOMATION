...
class BankAccountCreation {
  ...
  viewBankFieldCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.bank);
  ...
  viewBankBranchFieldCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.bankBranch);
      cy.log(messages.ui.viewField);
    });
  }
  ...
  viewAccountNameEnCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.accountNameEn);
      cy.log(messages.ui.viewField);
    });
  }
  ...
  viewAccountNameBnCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.accountNameBn);
      cy.log(messages.ui.viewField);
    });
  }
  ...
  viewAccountTypeCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.accountType);
      cy.log(messages.ui.viewField);
    });
  }
  ...
  viewAccountNumberCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.accountNumber);
      cy.log(messages.ui.viewField);
    });
  }
  ...
  viewStatusCheck() {
    ...
    cy.fixture(this.test_data).then((data) => {
      const baData = data.mfiAdmin.createBankAccountFrom;
      this.getVisibleViewLabel(baData.viewLabels.status);
      cy.imsId(COMMON.BUTTONS.GO_BACK).click();
      cy.log(messages.ui.viewField);
    });
  }
