// npm run auto
// npm run dev
// npx cypress run --spec cypress/e2e/01-mfi-admin/01-mis/44-holiday/holiday.cy.js --browser chrome --headed
...
describe("44. Holiday Module Test Cases", function () {
  ...
  it("44.02. Verify the holiday create reset button functions correctly.", function () {
    create_holiday.createResetButton();
  });

  it("44.03. Verify the holiday create submit button functions correctly.", function () {
    create_holiday.createSubmitButton();
  });

  it("44.04. Verify the holiday create go back button functions correctly.", function () {
