// npm run auto
// npm run dev
// npx cypress run --spec cypress/e2e/01-mfi-admin/01-mis/31-loan-account-management/loan-account-management.cy.js --browser chrome --headed
...
describe("31. Loan Account Management Module Test Cases", function () {
  ...
  it('31.08. Verify the functionality and expected behavior of the "Successful samity Status" dropdown.', function () {
    create_loan_account_management.statusSamityDropdownCheck();
  });

  it("31.09. Verify Successful Reset of Grid List Using the Reset Button on Loan Account Management  Page.", function () {
    create_loan_account_management.gridResetButtonCheck();
  });

  it("31.10. Verify Successful Refresh of Grid List Using the Refresh Button on Loan Account Management  Page.", function () {
    create_loan_account_management.gridRefreshButtonCheck();
  });

  it("31.11. Verify that when the user clicks the Search button on the loan account management grid page, the system redirects to the loan account management List page..", function () {
    create_loan_account_management.gridSearchButtonCheck();
  });

  it("31.12. Verify check that the grid list content changes correctly from english to bangla.", function () {
